...
<div class="container" style="width: 600px; height: 400px;margin: 100px auto; ">
   <div class="jumbotron " style="padding-left: 100px; padding-right: 100px;">
	    ...
	    <form class="bs-example bs-example-form" role="form" method="post" id="myform" action="${pageContext.request.contextPath}/login/handle.do">
	        <div class="input-group input-group-lg  ">
	            <span class="input-group-addon">帐户</span>
	            <input type="text" class="form-control" placeholder="帐&nbsp;&nbsp;户" id="username" name="username" value="admin"/>
	        </div>
	        <br>
	        <div class="input-group  input-group-lg ">
	            <span class="input-group-addon">密码</span>
	            <input type="password" class="form-control"  placeholder="密&nbsp;&nbsp;码" id="password" name="password" value="111111"/>
	        </div>
