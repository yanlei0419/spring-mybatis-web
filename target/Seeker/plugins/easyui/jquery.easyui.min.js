...
//tlw 2014.1.16 修改为中文提示
},beforePageText:"第",afterPageText:"页,共{pages}页",displayMsg:"共{total}条,当前{from}-{to}条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
//tlw 2014.1.16 默认属性，修改了个提示为中文
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:true,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:true,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"正在加载,请稍候 ...",rownumbers:true,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:true,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_695,_696){
