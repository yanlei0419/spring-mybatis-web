								...
								<div id="lbox_middleleft">
									<div id="lbox_middleright">
										<div id="bs_left" style="width:150px;">
											<IFRAME scrolling="auto" onload="loadFrame(this)" width="100%" frameBorder=0 id="frmleft" name="frmleft" src="${pageContext.request.contextPath}/frame/leftPages/admin_menu_s.jsp" allowTransparency="true"></IFRAME>
										</div>
